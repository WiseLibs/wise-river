...
class Observable extends FastQueue {
	...
	[shared.writePromise](promise) {
		// TODO? As an alternative to racingToStream?
	}
...
const flushObservable = (obsv) => () => {
	...
	// TODO: this should really happen after anything is processed, to account for racingToStream
