...
// - function callbacks are used to indicate termination, instead of the promise interface
...
class Observable extends FastQueue {
	...
	constructor(fn) {
		...
		// TODO: notify parent class of errors
		//      (i don't think clean closes need notifications because i think they can only be caused by the parent class)
	}
