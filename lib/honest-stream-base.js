...
/*
	HonestStreamBase implements the low-level interface of HonestStream.
	All other methods of HonestStream are derived from methods in this class.
 */
class HonestStreamBase extends Observable {
	...
	constructor(fn) {
		...
		if (tryCatch(fn, resolve, reject, write, free) === exception) {
