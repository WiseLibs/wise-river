...
Most object streaming solutions in Node.js are highly opinionated or even esoteric, and they often don't compose well with promises (the sanctioned asynchronous primitive for JavaScript). Even the streams provided by the standard library exhibit many of these problems:
