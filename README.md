...
Constructs an array containing each item written to the stream, and returns a promise for that array. The items in the array will appear in the order that the stream received them.
